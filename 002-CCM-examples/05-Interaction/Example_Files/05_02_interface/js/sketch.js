 ...
 * ---------
 * 
 * This file is an example of how to implement an interface that allows users to control various aspects of the sketch.
 *
 * What this file does:
 ...
 * - Provides a control panel (see 'index.html' and 'interface.js') that allows users to adjust settings in real-time.
 *
 * Note: The actual implementation of the control panel and its event handlers is included in 'index.html' and 'interface.js'. 
 * */
...
// ––– Typewriter –––
let typewriterActive = false;          // Whether the typewriter animation is active
...
function setup() {
  ...
  // Move the canvas into the 'canvas-wrapper' div in the HTML, so it sits next to the control panel instead of above it.
